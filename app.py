...
def display_user_info(usr):
    user_image = '"' + usr.avatar_url + '"'
    user_name = usr.name
    user_login = usr.login
    user_location = usr.location
    user_url = usr.html_url
    ...
    with col1_1:
        ...
        <body>
            ...
            <img src= """ + user_image + """alt ="Avatar" style="width:175px">
        </body>""",
        width=250, height=250)
    col1_2.markdown("##### " + user_login)
    if user_name is not None:
        col1_2.write(" " + user_name)
    if user_location is not None:
        col1_2.write(user_location)
    if user_url is not None:
        col1_2.markdown("""[Link to Profile](""" + user_url + """)""")
